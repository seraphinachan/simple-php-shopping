...
<body>
                ...
                foreach ($_SESSION['cart'] as $key => $value) 
                {
                  ...
                  echo
                    ...
                    <tr>
                      ...
                      <td><input class='text-center iquantity' name='Mod_Quantity' onchange='subTotal()' type='number' value='$value[Quantity]' min='1' max='99'></td>
                      <td class='itotal'></td>
                      <td>
      ...
      <div class="col-lg-3">
        <div class="border bg-light rounded p-4">
          <form action="pay.php" method="POST">
            <div class="row">
              <label class="form-label" id="istotal"></label>
            </div>
            <div class="row">
              <label class="form-check-label" id="scost"></label>
            </div>
            <hr>
            <div class="row">
              <label class="form-label" id="gtotal"></label>
            </div>
            <button class="btn btn-primary btn-block mt-1" type="submit">구매하기</button>
          </form>
        </div>
      </div>
  ...
  <script>
    ...
    function subTotal() {
      ...
      var shipping_cost = (gt < 30000) ? 3000 : 0;
